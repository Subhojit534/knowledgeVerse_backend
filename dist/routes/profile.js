...
async function handleIntro(req, res) {
    try {
        const body = req.body || {};
        ...
        const updatedProfile = await saveProfile({
            ...
            avatar_index: body.avatar_index ?? 0,
            xp: 150,
            level: 1,
            coins: 500,
            gems: 25,
...
profileRouter.put('/me', async (req, res) => {
    try {
        ...
        const updated = await saveProfile({
            ...
            avatar_index: updates.avatar_index !== undefined ? updates.avatar_index : existing.avatar_index,
