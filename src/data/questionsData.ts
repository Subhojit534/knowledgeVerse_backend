...
export const predefinedQuestions: Record<string, LearningContentPayload> = {
  ...
  math_real: {
    ...
    explanation:
      'The Fundamental Theorem of Arithmetic states that every composite number can be uniquely expressed as a product of primes. Euclid\'s Division Lemma and prime factorization allow calculating HCF, LCM, and proving irrationality (such as √2, √3).',
    audio_available: false,
    source: 'prepopulated',
  ...
  math_poly: {
    ...
    explanation:
      'Quadratic equations have the standard form ax² + bx + c = 0. The nature of roots is determined by the discriminant D = b² - 4ac: two distinct real roots if D > 0, two equal real roots if D = 0, and no real roots if D < 0.',
    audio_available: false,
    source: 'prepopulated',
  ...
  math_trig: {
    ...
    explanation:
      'Trigonometry relates side ratios to angles in right triangles: sin θ = opp/hyp, cos θ = adj/hyp, tan θ = opp/adj. Key identities: sin²θ + cos²θ = 1, 1 + tan²θ = sec²θ, and 1 + cot²θ = cosec²θ.',
    audio_available: false,
    source: 'prepopulated',
  ...
  math_linear: {
    ...
    explanation:
      'A system a₁x + b₁y + c₁ = 0 and a₂x + b₂y + c₂ = 0 has a unique solution when a₁/a₂ ≠ b₁/b₂, infinitely many solutions when lines coincide (a₁/a₂ = b₁/b₂ = c₁/c₂), and no solution when lines are parallel.',
    audio_available: false,
    source: 'prepopulated',
  ...
  math_ap: {
    ...
    explanation:
      'In an Arithmetic Progression with first term a and common difference d, the nth term is a_n = a + (n - 1)d, and sum S_n = n/2 [2a + (n-1)d]. Thales\' theorem states that a line parallel to one triangle side divides other sides proportionally.',
    audio_available: false,
    source: 'prepopulated',
  ...
  math_coord: {
    ...
    explanation:
      'Distance between (x₁, y₁) and (x₂, y₂) is d = √[(x₂ - x₁)² + (y₂ - y₁)²]. The Section Formula divides a line in ratio m:n. Probability P(E) = favorable outcomes / total outcomes (0 ≤ P(E) ≤ 1).',
    audio_available: false,
    source: 'prepopulated',
  ...
  phys_light: {
    ...
    explanation:
      'Light reflects off mirrors following the Law of Reflection and refracts through lenses by Snell\'s Law: n₁ sin(i) = n₂ sin(r). Mirror formula: 1/f = 1/v + 1/u. Lens formula: 1/f = 1/v - 1/u. Convex lenses converge rays, concave diverge.',
    audio_available: false,
    source: 'prepopulated',
  ...
  phys_electricity: {
    ...
    explanation:
      'Ohm\'s Law states V = IR. In series circuits, current is constant and resistances add (R_eq = R₁ + R₂). In parallel circuits, voltage is constant and reciprocals add (1/R_eq = 1/R₁ + 1/R₂). Joule heating law: H = I²Rt.',
    audio_available: false,
    source: 'prepopulated',
  ...
  chem_reactions: {
    ...
    explanation:
      'Chemical equations must obey the Law of Conservation of Mass. Main types of reactions: Combination (A+B→AB), Decomposition (AB→A+B), Displacement (A+BC→AC+B), Double Displacement, and Redox (simultaneous Oxidation and Reduction).',
    audio_available: false,
    source: 'prepopulated',
  ...
  chem_acids: {
    ...
    explanation:
      'Acids release H⁺ ions in water (pH < 7), while bases release OH⁻ ions (pH > 7). A neutral solution has pH = 7. Acid + Base → Salt + Water (Neutralization). Common salts include NaCl, NaHCO₃ (Baking soda), Na₂CO₃·10H₂O (Washing soda), and CaSO₄·½H₂O (Plaster of Paris).',
    audio_available: false,
    source: 'prepopulated',
  ...
  bio_cell: {
    ...
    explanation:
      'The cell is the basic structural and functional unit of life. Mitochondria generate ATP energy via cellular respiration. The nucleus contains DNA organized in chromosomes. Plant cells possess cell walls and chloroplasts for photosynthesis.',
    audio_available: false,
    source: 'prepopulated',
  ...
  hist_ancient: {
    ...
    explanation:
      'The Indus Valley Civilization (c. 2500–1900 BCE) is celebrated for advanced urban planning, grid-based street layouts, underground brick drainage systems, and the Great Bath at Mohenjo-Daro.',
    audio_available: false,
    source: 'prepopulated',
